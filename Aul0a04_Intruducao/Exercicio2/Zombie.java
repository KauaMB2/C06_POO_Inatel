package Aul0a04_Intruducao.Exercicio2;
...
public class Zombie {
    ...
    public void transferHealth (Zombie targetZombie, int amount) {
        if (this.isAlive() && targetZombie.isAlive()) {
            if(this.getHealth() >= amount) {
                targetZombie.health += amount;
                this.health -= amount;
            }else{
